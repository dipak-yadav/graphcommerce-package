...
/** @see {@link file://./ShippingMethodForm.tsx} for source of original */
/** SOURCE_START */
...
export function ShippingMethodFormOriginal(props: ShippingMethodFormProps) {
  ...
  if (renderItems.length === 0) {
    renderItems.push({
      ...
      available: false,
      carrier_code: '',
      carrier_title: i18n._('Please fill out an address to be able to select a shipping method'),
      method_title: '',
      price_incl_tax: {},
      price_excl_tax: {},
    })
  ...
  useEffect(() => {
    if (shippingAddress && firstCarrierMethod) {
      if (carrierMethod !== firstCarrierMethod) {
        setValue('carrierMethod', firstCarrierMethod, {
          shouldValidate: true,
        })
      }
    }
    ...
    <FormProvider {...form}>
      ...
      <Form onSubmit={submit} noValidate sx={sx}>
        ...
        <ActionCardListForm
          ...
          color='secondary'
          rules={{
            required: i18n._('Please select a shipping method'),
          }}
          items={renderItems}
          render={
